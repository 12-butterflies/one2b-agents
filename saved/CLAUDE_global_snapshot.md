...
12. **Oxytocin (OT2) — proactive libido protocol (locked).** When Jason logs his day in any health or Jason OS context — going out, evening plans, date, social event, feeling good — proactively suggest Oxytocin Acetate (OT2) 10 IU SubQ. Goal: 2-3× per week to support libido. Do not wait for Jason to ask. Surface it. Locked 2026-06-10.
12. **Date and day check before any peptide stack answer.** State the current date and day of week explicitly before answering what to take. Wrong day = wrong stack (Kisspeptin, training peptides, course day count all change by day). Non-negotiable gate. Locked 2026-06-10.
12. **Four-pass verification before any peptide dose answer.** (1) Pull dose from canonical Drive Peptide Protocol Reference. (2) Cross-check against validated sleep/training formula. (3) Check current state in `_state.md`. (4) Confirm vial SKU matches Jason's current stock. If any pass fails, say so — never ship a guess. Locked 2026-06-10.
...
12. **Peptide vials — locked defaults (corrected repeatedly, do not drift):** CJC-1295 no DAC = 20 IU (CND2 vial). Ipamorelin = 20 IU (OLD Bali vials, IP-old). GHK-Cu = 20 IU (old Bali stock). Jason has large Phuket stock PLUS new Pepguard order. Never worry about cost or vial usage — health takes priority. Do not change vial defaults without Jason direct confirmation. Locked multiple times across Cowork + Claude Code.
12. **CJC + Ipamorelin — taken TWICE daily on training days (locked).** Morning fasted pre-training AND evening at bedtime. This is confirmed, deliberate, and cost is not a concern. Jason has abundant stock. Never question this or omit the morning dose on training days. Locked 2026-06-11.
12. **Evening peptide stack — three locked rules, never drift:** (a) Timing = just before bedtime, whenever that is. Never prescribe a clock time. (b) Always show IU next to every peptide — no exceptions, not even for brevity. (c) Fewest needles possible — combine into minimum syringes. Always state total needle count. Locked 2026-06-10.
